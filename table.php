		...
		<div class="container">
			<div class="row justify-content-center">
				<div class="col-md-6 text-center mb-5">
					<h2 class="heading-section">EDITOR'S TABLE</h2>
					<a href="admin_home.php">HOME PAGE</a></div>
			</div>
			<div class="row">
				<div class="col-md-12">
					...
					<div class="table-wrap">
                        ...
                        <?php
        $conn=  mysqli_query($conn, "select * from news");
            $i=0;
...

            {
                ?>
						...
						<tr style="height:200px">
                            ...
                            <td><a href="preview.php?edit=<?php echo $row['n_id']; ?>"" class="btn btn-primary">Read more</a></td>
					      </tr>
						  <?php
							}
							?>
